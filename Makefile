...
install :; forge install foundry-rs/forge-std --no-commit && forge install openzeppelin/openzeppelin-contracts@v4.9.5 --no-commit && forge install rari-capital/solmate --no-commit
